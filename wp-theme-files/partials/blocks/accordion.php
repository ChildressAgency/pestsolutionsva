  ...
  <?php $i = 0; while(have_rows('accordion')): the_row(); ?>
    <div class="card">
      <div id="accordion-title-<?php echo $i; ?>" class="card-header">
        <h4>
          <button class="opener collapsed" data-toggle="collapse" data-target="#accordion-content-<?php echo $i; ?>" aria-expanded="false" aria-controls="accordion-content-<?php echo $i; ?>"><?php the_sub_field('accordion_title'); ?></button>
        </h4>
      </div>
